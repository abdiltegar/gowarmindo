        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse" id="navbarKu">
            <ul class="navbar-nav ms-auto mb-2 mb-lg-0 ">
                ...
                <li class="nav-item">
                    <a class="nav-link active" aria-current="page"  href="testimoni.php">Testimoni</a>
                </li>
                <li class="nav-item">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <ul>
                                        ...
                                        <li>20190140128 - Seliesca Whidya Permata</li>
                                        <li>	20190140036 - Rivky Riyantoro</li>
                                        <li>	20190140056 - Hasna Shabrina</li>
                                        <li>	20190140043 - Annisa Yasfa Nabilla</li>
                                        <li>	20190140022 - Laela Wulida Imroatus Solikha</li>
                                        <li>	20190140124 - Erlinda Efrilia</li>
                                        <li>	20190140127 - Nadzira Azzahra</li>
                                        <li>	20190140054 - Moh Sigit</li>
                                        <li>	20190140086 - Abdil Tegar Arifin</li>
                                        <li>	20190140072 - Anisa Nurfadila Dwi Karina</li>
                                        <li>	20190140130 - Muhammad Anshori Akbar</li>
                                        <li>	20190140082 - Denise Nataya Wibisono</li>
                                        <li>	20190140059 - Hakeem Gufran</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
