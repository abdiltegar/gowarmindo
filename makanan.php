                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-striped">
                            ...
                            <tbody>
                                <tr>
                                    <td>1.</td>
                                    <td>Indomie (Rebus / Goreng) Tante</td>
                                    <td>Rp. 5.000</td>
                                </tr>
                                <tr>
                                    <td>2.</td>
                                    <td>Indomie (Rebus / Goreng) Telor</td>
                                    <td>Rp. 7.000</td>
                                </tr>
                                <tr>
                                    <td>3.</td>
                                ...
                                <tr>
                                    <td>9.</td>
                                    <td>Telor Goreng Polos</td>
                                    <td>Rp. 3.500</td>
                                </tr>
                                <tr>
                                    <td>10.</td>
                                    <td>Telor Oseng Sambel</td>
                                    <td>Rp. 5.000</td>
                                </tr>
                                <tr>
                                    <td>11.</td>
                                ...
                                <tr>
                                    <td>14.</td>
                                    <td>Telor 1/2 Matang</td>
                                    <td>Rp. 3.500</td>
                                </tr>
                                <tr>
                                    <td>15.</td>
                                    <td>Indo Telor Dadar</td>
                                    <td>Rp. 7.500</td>
                                </tr>
                                <tr>
                                    <td>16.</td>
